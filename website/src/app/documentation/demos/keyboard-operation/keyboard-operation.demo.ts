...
import { CONTROL_ENTER_BASIC_EXAMPLE, FOCUS_FIRST_INVALID_EXAMPLE } from './keyboard-operation-examples.demo';
...
export class KeyboardOperationDemo extends ClarityDocComponent implements OnInit {
  ...
  translationServiceInterfaceExample = `
interface ClrControlEnterSubmitTranslationService {
  translate(key: string): string;
}
`;

  translationServiceProviderExample = `
providers: [{
  provide: CLR_CONTROL_ENTER_SUBMIT_TRANSLATION,
  useClass: MyTranslationService
}]
`;
