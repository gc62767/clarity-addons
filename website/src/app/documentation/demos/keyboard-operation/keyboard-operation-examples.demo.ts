...
<!-- 1. With translation key (shows tooltip if service provided) -->
<form [clrControlEnterSubmit]="'SUBMIT_KEY'" (ngSubmit)="onCtrlEnterSubmit()" #form="ngForm">
  <clr-input-container>
...
<!-- 2. Without translation key (no tooltip) -->
